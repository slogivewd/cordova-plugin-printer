...
exports.onPrintTaskRequested = function (event) {
	...
	if (config.paper && config.paper.name) {
		spec.mediaSize =
			Printing.PrintMediaSize[config.paper.name] ||
			Printing.PrintMediaSize.default;
	}
...
PrintManager.getForCurrentView().onprinttaskrequested =
	exports.onPrintTaskRequested;
